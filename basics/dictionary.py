...
# pop - метод, который принимает ключ, удаляет пару под этим ключом (ключ и его значение). возвращает удаленное значение 

#ИЗ ГИТА СКОПИРОВАТЬ

#popitem - метод, который удаялет пару, которая была добавлена последней в словарь
