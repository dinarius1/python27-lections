...
# 2. При наследовании миксины должны идти в первую очередь (при наследовании необходимо наследовать сначала обязательно от миксинов, а потом уже от обычных классов)
